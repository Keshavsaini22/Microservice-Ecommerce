...
function Right() {
    ...
    return (
        <Stack p={1.5} sx={{ backgroundColor: 'white', borderRadius: '10px', height: '526px' }} >
            <Stack direction={'row'} justifyContent={'space-between'}>
                ...
                <CustomButton onclick={() => { }} sxprops={{ sx: { width: '180px', height: '35px' } }} variant="outlined" text="Cancle order" />
